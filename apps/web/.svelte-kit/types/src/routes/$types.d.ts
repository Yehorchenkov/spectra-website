...
type LayoutRouteId = RouteId | "/" | "/about" | "/blog" | "/events" | "/events/[slug]" | "/network" | "/news" | "/news/[slug]" | "/privacy-policy" | "/projects" | "/projects/[slug]" | "/repository" | "/services" | "/team-members" | "/team-members/[slug]" | null
