...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/about" | "/api" | "/api/coordinators" | "/api/news" | "/api/og" | "/api/partners" | "/api/programs" | "/api/projects" | "/api/seo-settings" | "/api/team-members" | "/blog" | "/events" | "/main-page" | "/network" | "/news" | "/news/[slug]" | "/privacy-policy" | "/projects" | "/projects/[slug]" | "/repository" | "/services" | "/team-members" | "/team-members/[slug]";
		RouteParams(): {
