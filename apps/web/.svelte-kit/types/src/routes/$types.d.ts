...
type LayoutRouteId = RouteId | "/" | "/about" | "/blog" | "/events" | "/network" | "/news" | "/privacy-policy" | "/projects" | "/projects/[slug]" | "/repository" | "/services" | "/team-members" | "/team-members/[slug]" | null
