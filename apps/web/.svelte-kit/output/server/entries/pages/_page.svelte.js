import { m as derived, n as bind_props, p as props_id, v as spread_props, k as attributes, l as escape_html, h as attr, q as ensure_array_like, o as stringify, t as attr_class } from "../../chunks/index.js";
import { twMerge } from "tailwind-merge";
import { g as getIconContext } from "../../chunks/context.js";
import { B as Button, a as ButtonLink } from "../../chunks/buttonLink.js";
import { R as RichTextRenderer } from "../../chunks/RichTextRenderer.js";
import { t as tick } from "../../chunks/index-server.js";
import { N as NEWS_PLACEHOLDER } from "../../chunks/constants.js";
import { C as CalendarDots } from "../../chunks/CalendarDots.js";
import { f as formatDateLong } from "../../chunks/dateHelpers.js";
import { w as watch, i as isHTMLElement, f as executeCallbacks, h as isElement, C as Context, s as simpleBox, b as boxWith, a as attachRef, j as isFocusVisible, d as createBitsAttrs, k as boolToEmptyStrOrUndef, n as noop, e as createId, m as mergeProps } from "../../chunks/create-id.js";
import { M as on } from "../../chunks/events.js";
import { b as boxAutoReset } from "../../chunks/box-auto-reset.svelte.js";
import { a as getWindow, g as getDocument, D as DOMContext } from "../../chunks/use-id.js";
...
function Partnership($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    DottedWorld($$renderer2, { partners: data.docs });
    $$renderer2.push(`<!----></div>`);
  });
}
