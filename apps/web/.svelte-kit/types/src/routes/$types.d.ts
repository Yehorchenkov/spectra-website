...
type LayoutRouteId = RouteId | "/" | "/about" | "/blog" | "/events" | "/network" | "/news" | "/news/[slug]" | "/privacy-policy" | "/projects" | "/projects/[slug]" | "/repository" | "/services" | "/team-members" | "/team-members/[slug]" | null
